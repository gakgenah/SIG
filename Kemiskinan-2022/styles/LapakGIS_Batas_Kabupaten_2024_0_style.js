...
var style_LapakGIS_Batas_Kabupaten_2024_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (label_LapakGIS_Batas_Kabupaten_2024_0_eval_expression(context) !== null) {
        labelText = String(label_LapakGIS_Batas_Kabupaten_2024_0_eval_expression(context));
    }
    if (value > 0.000000 && value <= 95.330000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 95.330000 && value <= 190.660000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 190.660000 && value <= 286.140000) {
            style = [ new ol.style.Style({
